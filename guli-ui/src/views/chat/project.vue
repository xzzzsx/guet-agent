      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['system:project:select']"
            >选择</el-button
          >
        </template>
      </el-table-column>
        ...
        <el-form-item label="文件上传" prop="fileUpload">
          ...
          >
            ...
            <div slot="tip" class="el-upload__tip">
              只能上传txt、word、pdf文件，如果需要查看文件详情，请移步知识库管理
            </div>
          </el-upload>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      models: ["openai qwen", "ollama qwen2.5:1.5b"],
      fileList: [],
      fileData: {},
  ...
  methods: {
    ...
    async handleSelect(row) {
      console.log("开始处理项目选择，项目ID:", row.projectId);
      const projectIdStr = String(row.projectId);
